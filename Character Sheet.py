...
if print_to_html_file == "Y" or print_to_html_file == "y" or print_to_html_file == "Yes" or print_to_html_file == "Yes":
    ...
    html_code = [""]
    html_code.append("<html><body><p>")
    html_code.append("<h2>" + name + "</h2>")
    html_code.append("<hr>")
    html_code.append("<table>")
    html_code.append("<tr><td>Name: </td><td>" + name + "</td></tr>")
    ...
    html_code.append("------------------------------</br>")
    html_code.append("<table>")
    html_code.append("<tr><td>Health: </td><td>" + str(health) + "</td></tr>")
